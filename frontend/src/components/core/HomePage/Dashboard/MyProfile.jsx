...
import { formattedDate } from "../../../../utils/datefirmatter"
...
export default function MyProfile(){
    ...
    //scorll to the top of the page when the component mounts
    useEffect(()=>{
        window.scrollTo(0,0);
    },[])
    return(
        <>
         <h1 className="mb-14 text-4xl mt-5  text-richblack-5 font-bold text-center "> My Profile</h1>
         ...
         <div className="my-10 flex flex-col gap-y-10 rounded-2xl border-[1px] border-richblack-700 bg-richblack-800 p-8 px-7 sm:px-12">
            ...
            <div className="flex max-w-[500px] justify-between ">
                <div className="flex flex-col gap-y-5">
                    ...
                    <div>
                    <p className="mb-2 text-sm text-richblack-500">Account Type</p>
                    <p className="text-sm font-semibold text-richblack-5 capitalize">
                        {user?.accountType}
                    </p>
                    </div>
