...
import CourseAccordionBar from "../components/core/HomePage/Course/CourseAccordionBar";
import CourseDetailsCard from "../components/core/HomePage/Course/CourseDetailsCard";
...
function CourseDetails() {
    ...
    useEffect(() => {
        const fetchCourseDetailsData = async () => {
            try {
                ...
                setCourse(res?.courseDetails?.[0] || null); // set single course object
            } catch (error) {
                console.log("Could not fetch the course details", error);
            }
        };
    ...
    return (
        <>
            <div className="relative w-full text-white bg-richblack-800">
                <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative">
                    ...
                    <div className="right-[1.5rem] top-[60px] mx-auto lg:absolute min-h-[600px] w-1/3 max-w-[410px] translate-y-24 md:translate-y-0">
                        {course && (
                            <CourseDetailsCard
                                course={course}
            ...
            <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
                <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
                    <div className="my-8 border border-richblack-600 p-8">
                        ...
                        <div className="mt-3">
                            {(Array.isArray(whatYouWillLearn) ? whatYouWillLearn : whatYouWillLearn?.split("\n") || []).map(
                                (line, index) => (
