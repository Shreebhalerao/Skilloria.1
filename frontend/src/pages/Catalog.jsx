...
import Course_Card from "../components/core/HomePage/Catalog/Course_Card"
import Course_Slider from "../components/core/HomePage/Catalog/Course_Slider"
    ...
    useEffect(() => {
        ; (async () => {
            try {
                ...
                console.log("catalogPageData response:", res)
        ...
        <>
            ...
            <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                <div className="section_heading  text-white">
                    Top courses in {catalogPageData?.name}
                </div>
                <div>
                    <Course_Slider
